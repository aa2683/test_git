...
df_data_h3['lng_centroid'] = df_data_h3.h3.h3_to_geo()['geometry'].apply(lambda x:x.x)
df_data_h3['lat_centroid'] = df_data_h3.h3.h3_to_geo()['geometry'].apply(lambda x:x.y)
